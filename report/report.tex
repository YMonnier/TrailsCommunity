...
\hline
23 & Teste l'affichage d'erreur du champs mot de passe de la vue SessionFormActivity & Teste pour le champs mot de passe si l'affichage du cas d'erreur fonctionne si le champs est vide \\
\hline
24 & Teste la modification des données de l'utilisateur de la vue ProfileActivity & Ajoute dans tout les champs des données valide pour tester la modification des données de l'utilisateur courant \\
\hline
25 & Teste l'affichage d'erreur du champs pseudonyme de la vue ProfileActivity & Teste pour le champs pseudonyme  si l'affichage du cas d'erreur fonctionne si le champs est vide \\
\hline
26 & Teste l'affichage d'erreur du champs numéro de téléphone de la vue ProfileActivity & Teste pour le champs numéro de téléphone si l'affichage du cas d'erreur fonctionne si le champs est vide \\
\hline \hline
\end{tabularx}
\end{table}
